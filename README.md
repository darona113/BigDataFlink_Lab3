# BigDataFlink — готовый проект для ЛР №3

Готовое решение лабораторной работы по предмету **«Анализ больших данных»**:
...
## Примечание по исходным файлам

В этом архиве десятый файл сохранён как `MOCK_DATA (10).csv`.
Он собран из вашего загруженного файла `MOCK_DATA (12).csv`, чтобы структура репозитория выглядела аккуратно и соответствовала формату задания с 10 CSV-файлами.

## Что сдавать

В качестве результата можно отправлять весь этот репозиторий целиком.

Минимум для сдачи уже есть:
